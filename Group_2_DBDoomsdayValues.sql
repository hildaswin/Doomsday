...
VALUES
	...
	('WA0011', 'St James Park Lake', 2, 3, 'LO0002'),
	...
	('WA0019', 'Goethals Pond', 1, 2, 'LO0003'),
	('WA0020', 'Tidal Wetlands Area', 1, 5, 'LO0003'),
	...
	('WA0032', 'Sahara Heart Oasis', 8, 7, 'LO0007'),
	('WA0033', 'Tidal Basin', 5, 10, 'LO0008'),
	('WA0034', 'Potomac River', 8, 10, 'LO0008'),
	('WA0035', 'WH Rain Collect Sys', 8, 5, 'LO0008'),
	('WA0036', 'Pacific Ocean', 4, 10, 'LO0009'),
	('WA0037', 'Water Filtration', 10, 8, 'LO0009'),
	('WA0038', 'Sea of Japan', 4, 10, 'LO0010'),
	('WA0039', 'Water Cooling System', 1, 4, 'LO0010'),
	...
	('WA0054', 'Water Filtrate Sys', 10, 10, 'LO0014'),
	('WA0055', 'Drainage Canal', 2, 4, 'LO0014'),
	('WA0056', 'Blackwater Bay', 7, 10, 'LO0015'),
	('WA0057', 'Blackwater River', 6, 10, 'LO0015'),
	('WA0058', 'Shire Filtration Sys', 10, 5, 'LO0016'),
	('WA0059', 'Dark Forest Creek', 2, 4, 'LO0016'),
	('WA0060', 'Water Collect Sys', 7, 5, 'LO0016')
;
...
VALUES
	...
	('LD0002', 'St Peter Church', 'LO0001', 6),
	('LD0003', 'Fairfield Apartments', 'LO0001', 8),
	('LD0004', 'East Shopping Center', 'LO0001', 8),
	('LD0005', 'The Fairmore Center', 'LO0001', 9),
	('LD0006', 'Lancaster HighSchool', 'LO0001', 7),
	('LD0007', 'Lancaster University', 'LO0001', 9),
	('LD0008', 'Fairfield Infirmary', 'LO0001', 5),
	('LD0009', 'Fairfield Church', 'LO0001', 6),
	('LD0010', 'River Valley Mall', 'LO0001', 8),
	('LD0011', 'River Valley Housing', 'LO0001', 10),
	...
	('LD0020', 'Silverlock Medical', 'LO0002', 7),
	('LD0021', 'Tower of London', 'LO0002', 9),
	('LD0022', 'EmpireState Building', 'LO0003', 8),
	('LD0023', 'VU NY Condominiums', 'LO0003', 10),
	('LD0024', 'Fifth Avenue Hotel', 'LO0003', 10),
	('LD0025', 'The Ned NoMade', 'LO0003', 10),
	('LD0026', 'Made Hotel', 'LO0003', 10),
	('LD0027', 'Walker Hotel', 'LO0003', 10),
	('LD0028', 'Flatiron Building', 'LO0003', 9),
	('LD0029', 'Lexington Parc Condo', 'LO0003', 10),
	('LD0030', 'Merrion Row Hotel', 'LO0003', 10),
	('LD0031', 'Hotel Scherman', 'LO0003', 10),
	('LD0032', 'Art Institute', 'LO0004', 4),
	('LD0033', 'Thalia Hall', 'LO0004', 3),
	('LD0034', 'Museum Park Place', 'LO0004', 8),
	('LD0035', 'Adler Place Condos', 'LO0004', 10),
	('LD0036', 'Prairie Pointe Apt', 'LO0004', 10),
	('LD0037', 'Grant Luxury Condos', 'LO0004', 10),
	('LD0038', 'Soldier Field', 'LO0004', 2),
	('LD0039', 'Martha WA Apt', 'LO0004', 10),
	('LD0040', 'Newton Bateman Elem', 'LO0004', 4),
	('LD0041', 'North Park Apt', 'LO0004', 10),
	('LD0042', 'Research Camp', 'LO0007', 6),
	('LD0043', 'Ydris-Clan Hideout', 'LO0008', 2),
	('LD0044', 'Treasury Building', 'LO0008', 6),
	('LD0045', 'StJ Lafayette Square', 'LO0008', 5),
	('LD0046', 'Blair House', 'LO0008', 4),
	('LD0047', 'Eis Executive Office', 'LO0008', 7),
	('LD0048', 'WH Nuclear Bunker', 'LO0008', 9),
	('LD0049', 'Shallow Undrwtr Base', 'LO0009', 2),
	('LD0050', 'BlodRav Undrwtr Base', 'LO0009', 4),
	('LD0051', 'Alien Research Fac', 'LO0009', 1),
	('LD0052', 'Alien Surface Tower', 'LO0009', 6),
	('LD0053', 'Drop Off Overlook', 'LO0009', 8),
	('LD0054', 'PP Military Base', 'LO0010', 3),
	('LD0055', 'PP Emergency Bunker', 'LO0010', 7),
	('LD0056', 'Kariwa Elem School', 'LO0010', 5),
	('LD0057', 'Aband Log Factory', 'LO0011', 2),
	('LD0058', 'Aband Mining Site', 'LO0011', 1),
	('LD0059', 'Amber Excav Camp', 'LO0011', 2),
	('LD0060', 'Crystal Skull Temple', 'LO0011', 3),
	('LD0061', 'Yanomami Village', 'LO0011', 6),
	('LD0062', 'Expedition Site', 'LO0011', 5),
	('LD0063', 'US Military Base', 'LO0012', 6),
	('LD0064', 'Nuke Testing Ovrlook', 'LO0012', 5),
	('LD0065', 'Nuketown Residence', 'LO0012', 1),
	('LD0066', 'GG Guards Base', 'LO0013', 7),
	('LD0067', 'GG Staff Residence', 'LO0013', 8),
	('LD0068', 'GG Storage Facility', 'LO0013', 1),
	('LD0069', 'Oak Alley Residence', 'LO0014', 8),
	('LD0070', 'Plantation Huts', 'LO0014', 4),
	('LD0071', 'Oak Alley Manor', 'LO0014', 10),
	('LD0072', 'Oak Alley Bunker', 'LO0014', 10),
	('LD0073', 'Red Keep', 'LO0015', 8),
	('LD0074', 'King''s Landing Apt', 'LO0015', 9),
	('LD0075', 'Dragon View', 'LO0015', 6),
...
INSERT INTO Virus
VALUES
	('VT0001', 'Kharaa', 'Small green glowing blisters appear', 'Great Bar Reef Fish', 6),
	('VT0002', 'Gandaris', 'Increased leg endurance', 'North American Horse', 2),
	('VT0003', 'Otaundi', 'Yellow sclera', 'Malaysian Bats', 1),
	('VT0004', 'Eel''s Touch', 'Prone to static electricity', 'Amazon River Eel', 6),
	('VT0005', 'Calrhagia', 'Clots form faster', 'Canada Alien Prst', 7),
	('VT0006', 'Halluci', 'Increased frequency of hallucinations over time', 'Pacific Cuttlefish', 5),
	('VT0007', 'Astiones', 'Acidic saliva', 'Eurasian Centipedes', 7),
	('VT0008', 'Bleeding Sheep', 'Thinner skin, more prone to cuts', 'South American Frogs', 6),
	('VT0009', 'Crazy Marco', 'Increased thyroid gland activity, restlessness', 'El Sal Alien Prst', 7),
	('VT0010', 'Faminia', 'Stomach empties quicker, increased hunger', 'North American Deer', 5),
	('VT0011', 'Lich''s Hand', 'Prone to cold temperatures', 'Siberia Alien Prst', 7),
	('VT0012', 'Fire Virus', 'Skin becomes more resistant to fire', 'CA Salamanders', 2),
	('VT0013', 'Stomidia', 'Stomach acid is constantly produced', 'African Vulture', 9),
	...
	('VT0016', 'Tormenting Breath', 'Lung air sacs collapses over time', 'Indonesia Alien Prst', 9),
	('VT0017', 'Panda Curse', 'Increased fatigue frequency', 'Pandas of China', 6),
	('VT0018', 'Mycellid', 'Spore bulbs with stem starts to grow on skin', 'Alien parasite of OR', 8),
	('VT0019', 'Armori', 'Thicker skin, less prone to cuts', 'Rhinoceros', 1),
	('VT0020', 'Viralysis', 'Gradual skin breakdown', 'Germany Alien Prst', 9),
	('VT0021', 'Digero', 'Decreased digestive sys nutrient absorption', 'Variant of VT0010', 8),
	('VT0022', 'Coaguliro', 'Blood becomes thicker', 'Variant of VT0005', 9),
	('VT0023', 'Crystemia', 'Blood crystallizes', 'Variant of VT0005', 10),
	('VT0024', 'Sleeping Beauty', 'Sleepwalking increased duration and frequency', 'MI Alien Prst', 4),
    ('VT0025', 'Las Plagas Parasite', 'Complete takeover by the hive', 'Las Plagas Cult', 7),
	('VT0026', 'Vampire Virus', 'Severe reaction to sunlight exposure', 'Mutated Measles', 8),
	('VT0027', 'Simian Flu', 'Severe neuro-degeneration', 'Gen-Sys Laboratory', 9),
	('VT0028', 'Wairus', 'Slows neuron reaction time', 'Amazon Sloth', 3),
	('VT0029', 'Milky Way Strain', 'Causes dizziness when looking up', 'NV Alien Prst', 2),
	('VT0030', 'Bug''s Blood', 'Causes sticky sweats', 'LA Earthworms', 3),
	('VT0031', 'Cactus Sting', 'Constant urge to itch infected areas', 'Fleas of Nile River', 5),
	('VT0032', 'Greyscale', 'Causes hard grey skin that decays overtime', 'Mt Vesuv Alien Prst', 9)
;
